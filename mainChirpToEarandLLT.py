# -*- coding: utf-8 -*-
"""
Created on Mon Sep 22 16:12:52 2025
Code for chirp train response in the dead ear for the FAV course and in long lossy tube
DAta are saved into a folder
...
input("Put the probe into long lossy tube and press enter to continue recording... ")
...
filename = 'InLLTData'
caldata = {'Hinear1':Hinear1,'Hinear2':Hinear2,'fxinear':fxinear,'AmpChirp':AmpChirp,'Psrc1':Psrc1,'Psrc2':Psrc2,'Zsrc1':Zsrc1,'Zsrc2':Zsrc2,'Z01':Z01,'Z02':Z02,'fxTS':fxTS,'Zec1':Zec1,'Zec2':Zec2,'lat_SC':lat_SC,
     'PecsLLT1':PecsLLT1,'PecsLLT2':PecsLLT2}
