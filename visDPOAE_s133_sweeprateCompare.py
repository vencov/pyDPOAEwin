# -*- coding: utf-8 -*-
"""
Created on Wed Apr 16 14:44:20 2025
...
subjD['s133L_2oct'] = ['Results/s133/', '25_02_10_18_06_48_F2b_8000Hz', '25_02_10_18_07_36_F2b_8000Hz', '25_02_10_18_08_37_F2b_8000Hz', '25_02_10_18_09_22_F2b_8000Hz', '25_02_10_18_10_24_F2b_8000Hz', '25_02_10_18_11_25_F2b_8000Hz', '25_02_10_18_12_27_F2b_8000Hz', '25_02_10_18_13_28_F2b_8000Hz', '25_02_10_18_14_43_F2b_8000Hz', '25_02_10_18_16_30_F2b_8000Hz', '25_02_10_18_18_01_F2b_8000Hz']
subjD['s133L_8oct'] = ['Results/s133/highspeed/', '25_02_10_18_23_17_F2b_8000Hz', '25_02_10_18_23_51_F2b_8000Hz', '25_02_10_18_24_33_F2b_8000Hz', '25_02_10_18_25_15_F2b_8000Hz', '25_02_10_18_25_58_F2b_8000Hz', '25_02_10_18_26_49_F2b_8000Hz', '25_02_10_18_27_41_F2b_8000Hz', '25_02_10_18_28_33_F2b_8000Hz', '25_02_10_18_29_34_F2b_8000Hz']
...
for i in range(len(L2mensi)):
    ...
    ax2.plot(
        f2xx_R[idx1:],
        np.unwrap(np.angle(DPgr_R[str(L2mensi[i])]['NLgr'][idx1:])) / cycle+PhShR[i],
        '--',
        color=cList[i],
        label='_nolegend_'
    )
...
legend2 = ax1.legend(handles=l2_handles, title=r"$\mathit{L}_2$ dB FPL", title_fontsize=FSize-2, fontsize=FSize-4, loc='center left', bbox_to_anchor=(1, 0.5))
...
#%%  DP all signal, comparison for two levels
...
cList = ['C0','C1', 'C3', 'C2', 'C4', 'C5', 'C6', 'C7', 'C8', 'C9', 'C10', 'C11']
...
ax1.plot(
    f2xx_L,
    20 * np.log10(np.abs((DPgr_L[str(L2ch1)][comp])) / pREF),
    color=cList[i],
    label=str(L2ch1)
)
...
ax1.plot(
    f2xx_L,
    20 * np.log10(np.abs((DPgr_L[str(L2ch2)][comp])) / pREF),
    color=cList[i+2],
    label=str(L2ch2)
)
...
ax1.plot(
    f2xx_L,
    20 * np.log10(np.abs(DPgr_L[str(L2ch1)][comp+'N']) / pREF),
    ':',
    color=cList[i],
    label='_nolegend_'
)
...
ax1.plot(
    f2xx_L,
    20 * np.log10(np.abs(DPgr_L[str(L2ch2)][comp+'N']) / pREF),
    ':',
    color=cList[i+2],
    label='_nolegend_'
)
...
ax1.plot(
    f2xx_R,
    20 * np.log10(np.abs((DPgr_R[str(L2ch1)][comp])) / pREF),
    '-',
    color=cList[i+1],
    label='_nolegend_'
)
...
ax1.plot(
    f2xx_R,
    20 * np.log10(np.abs((DPgr_R[str(L2ch2)][comp])) / pREF),
    '-',
    color=cList[i+3],
    label='_nolegend_'
)
...
ax1.plot(
    f2xx_R,
    20 * np.log10(np.abs(DPgr_R[str(L2ch1)][comp+'N']) / pREF),
    ':',
    color=cList[i+1],
    label='_nolegend_'
)
...
ax1.plot(
    f2xx_R,
    20 * np.log10(np.abs(DPgr_R[str(L2ch2)][comp+'N']) / pREF),
    ':',
    color=cList[i+3],
    label='_nolegend_'
)
...
ax2.plot(
    f2xx_L[idx1:],
    np.unwrap(np.angle(DPgr_L[str(L2ch1)][comp][idx1:])) / cycle+PhShL[i],
    color=cList[i],
    label=str(L2ch1) + ', 2 oct/sec'
)
...
ax2.plot(
    f2xx_L[idx1:],
    np.unwrap(np.angle(DPgr_L[str(L2ch2)][comp][idx1:])) / cycle+PhShL[i],
    color=cList[i+2],
    label=str(L2ch2) + ', 2 oct/sec'
)

# Right ear phase (not in legend)
ax2.plot(
    f2xx_R[idx1:],
    np.unwrap(np.angle(DPgr_R[str(L2ch1)][comp][idx1:])) / cycle+PhShR[i],
    '-',
    color=cList[i+1],
    label= str(L2ch1) + ', 8 oct/sec'
)
...
ax2.plot(
    f2xx_R[idx1:],
    np.unwrap(np.angle(DPgr_R[str(L2ch2)][comp][idx1:])) / cycle+PhShR[i],
    '-',
    color=cList[i+3],
    label= str(L2ch2) + ', 8 oct/sec'
)
...
# Second legend: L2 values
legend2 = ax2.legend(title=r"$\mathit{L}_2$ dB FPL", title_fontsize=FSize-2, fontsize=FSize-4, loc='center left', bbox_to_anchor=(1, 0.5))
...
#%%  DP NL comp, comparison for two levels
