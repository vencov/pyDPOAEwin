...
import datetime
from UserModules.pyDPOAEmodule import RMEplayrec, generateDPOAEstimulus, calcDPgramFAV, generateDPOAEstimulusPhase, calcDPgramMatrix, calcDPgramFAV_HS, getSClat
...
latency_SC = getSClat(fsamp,bufsize)
micGain = 40
ear_t = 'R' # which ear
...
subj_name = 's003'
save_path = 'Results/s004/GACR_May1324'
subj_name = 's004'
