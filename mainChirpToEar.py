...
if FPL:
    ...
    # fig,ax = plt.subplots()
    # ax.plot(fxTS/1e3,20*np.log10(np.abs(Pecs1)/(np.sqrt(2)*2e-5)),'r')
    # ax.plot(fxTS/1e3,20*np.log10(np.abs(Pfor1)/(np.sqrt(2)*2e-5)),'b')
    # ax.plot(fxTS/1e3,20*np.log10(np.abs(Prev1)/(np.sqrt(2)*2e-5)),'g')
    # ax.plot(fxTS/1e3,20*np.log10(np.abs(Pifw1)/(np.sqrt(2)*2e-5)),'k')
